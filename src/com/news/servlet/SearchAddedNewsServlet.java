...
@WebServlet("/SearchAddedNewsServlet")
public class SearchAddedNewsServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<NewsData> news_list = userDao.getAddedNewsByTitleForVerify(newsname);

        //转发
        List<NewsData> topthree = userDao.getTopNews();
        request.setAttribute("topthree", topthree);
        session.setAttribute("listver",news_list);
