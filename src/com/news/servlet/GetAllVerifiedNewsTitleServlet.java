...
@WebServlet("/GetAllVerifiedNewsTitleServlet")
public class GetAllVerifiedNewsTitleServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        session.setAttribute("serchtype1","display:none");
        session.setAttribute("serchtype2","display:none");
        session.setAttribute("serchtype3","display:block");
        UserDaoInter userDao = new Userdao();
        List<NewsData> listver = userDao.getAllNewsByVerification(1);
