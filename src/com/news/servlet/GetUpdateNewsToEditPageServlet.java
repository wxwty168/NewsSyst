...
@WebServlet("/GetUpdateNewsToEditPageServlet")
public class GetUpdateNewsToEditPageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        NewsData newsData = userDao.getUpdateNewsById(news_id);
