...
@WebServlet("/VerifyAddedNewsServlet")
public class VerifyAddedNewsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //String verification_s = request.getParameter("verification");//1为通过，-1为不通过
        ...
        boolean isVerified = userDao.modifyVerificationStatusById(int_ids,1);
        if(isVerified){
            response.setContentType("text/html;charset=utf-8");
            PrintWriter out = response.getWriter();
