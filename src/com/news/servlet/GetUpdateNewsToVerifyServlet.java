...
@WebServlet("/GetUpdateNewsToVerifyServlet")
public class GetUpdateNewsToVerifyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        session.setAttribute("serchtype2","display:block");
        session.setAttribute("serchtype3","display:none");
        UserDaoInter userDao = new Userdao();
        List<NewsData> listver = userDao.getAllUpdateNewsTitleAndId();
