    ...
    <div class="container">
        ...
        <div class="hidden-xs">                <!--在超小屏幕下隐藏-->
            <ul class="nav navbar-nav">
                ...
                <li name="top" id="top4" class="active"><a href="javascript:location.href='ResetRealPageServlet?pageName='" style="display: block" >发布</a></li>
            </ul>
...
<div class="container">
    <form method="post" action="NewPublicServlet">
    <div class="col-md-8">
        <h1 class="news-title" ><input type="text" style="width: 600px;vertical-align:middle" placeholder="请输入您的新闻标题" name="newstitle" id="newstitle"><%--${news.title}--%></h1><!--搜索引擎，h1爬取权重较高-->
        <div class="new-info">当前时间：<span id="times"></span>&nbsp&nbsp&nbsp&nbsp新闻类别：
            <select name="newstype" id="newstype">
                <option value="1">科研工作</option>
                <option value="2">学生工作</option>
                <option value="3">党建工作</option>
                <option value="4">对外交流</option>
                <option value="5">校园生活</option>
            </select>
        </div>
        <div class="news-content">
            <textarea class="form-control" rows="30" cols="10" placeholder="请输入您的新闻内容" name="newscontent" id ="newscontent"></textarea>
        </div><br>
        <table class="table" align="center">
            <tr>
                <td align="center">
                <button type="submit" class="btn btn-warning" onclick="return checknewsform();">发布</button>
                </td>
                <td align="center">
